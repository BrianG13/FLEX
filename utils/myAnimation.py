...
class Animation:
    ...
    @property
    def shape(self): return (self.positions.shape[0], self.positions.shape[1])
...
def transforms_local(anim):
    ...
    transforms = anim.rotations.as_matrix().reshape(-1, anim.shape[1], 3, 3)
...
def rotations_load_to_maya(rotations, positions, names=None):
    ...
    if names is None: names = ["joint_" + str(i) for i in range(positions.shape[1])]
...
def load_from_network(translation, rotations, length, third_dimension=1, average_length=5, tanslation_scale=3):
    ...
    positions = np.zeros(((len(rotations), 32, 3)))
    PARENTS = [-1, 0, 1, 2, 3, 4, 0, 6, 7, 8, 9, 0, 11, 12, 13, 14, 12,
               16, 17, 18, 19, 20, 19, 22, 12, 24, 25, 26, 27, 28, 27, 30]
    offsets = np.asarray([[0, 0, 0],
                          [-12.719393604653, 0, 0],
                          [0, - 43.429100912261, 0],
                          [0, - 44.8767017425826, 0],
                          [0, 0, 15.1507020887566],
                          [0, 0, 7.49999965609858],
                          [12.719394002717, 0, 0],
                          [0, - 43.4291012978853, 0],
                          [0, - 44.8767016748485, 0],
                          [0, 0, 15.1507011912234],
                          [0, 0, 7.5000010571191],
                          [0, 0.1, 0],
                          [0, 24.5913012437421, 0],
                          [0, 24.8462964506057, 0],
                          [0, 9.27524780924562, 0],
                          [0, 11.4999962169752, 0],
                          [0, 24.8462964506057, 0],
                          [0, 12.4881979654096, 0],
                          [0, 25.9758046908119, 0],
                          [0, 24.5542024364365, 0],
                          [0, 0, 0],
                          [0, 0, 10.0000003353624],
                          [0, 9.99999671153582, 0],
                          [0, 0, 0],
                          [0, 24.8462964506057, 0],
                          [0, 12.4882003723488, 0],
                          [0, 25.9757993755427, 0],
                          [0, 24.5541985501975, 0],
                          [0, 0, 0],
                          [0, 0, 9.99999735957563],
                          [0, 13.7500030777855, 0],
                          [0, 0, 0]])
